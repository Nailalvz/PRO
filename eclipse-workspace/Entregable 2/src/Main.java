...
public class Main {
	...
	public static void main(String[] args) {
		...
		String opcion;
		boolean salir = false;
		//Programa correcto corregido 21/11
		
		while(!salir) {
			System.out.println("Bienvenido al menú principal.\nSeleccione una de las siguientes opciones:\n");
			System.out.println("Introduzca 1 para calcular cuantos días tiene un mes y un año concreto.");
			...
			case "1":
				...
				do {
					...
					año = scan.nextInt();
					if(año < 0) System.out.println("El año introducido no es válido.");
				}while(año < 0);
			...
			default:
				System.out.println("Debe seleccionar una de las opciones válidas.\n");
